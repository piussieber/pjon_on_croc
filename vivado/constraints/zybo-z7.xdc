...
# set_property -dict { PACKAGE_PIN Y7   IOSTANDARD LVCMOS33 }     [get_ports { jtag_trst_ni }];          #IO_L13P_T2_MRCC_13         Sch=jb_p[3]
...
# Pmod Header JD
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN T14  IOSTANDARD LVCMOS33 }     [get_ports { pjon_in}];          #IO_L5P_T0_34               Sch=jd_p[1]
set_property -dict { PACKAGE_PIN T15  IOSTANDARD LVCMOS33 }     [get_ports { pjon_io }];          #IO_L5N_T0_34               Sch=jd_n[1]
